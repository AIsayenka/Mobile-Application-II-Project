...
/**
 Implements the HTTP Basic authentication specification for adding an Authorization header to a EXPAPIRequest.
 */
@interface EXPBasicHTTPAuthentication : NSObject <EXPAPIAuthenticationProvider>
