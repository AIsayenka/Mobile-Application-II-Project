...
/**
 Strings within xAPI are localized using a language map.
 ...
 */
@interface EXPLanguageMap : EXPObject
{
    @private
    /**
     The EXPLanguageMap is really just a map for an NSDictionary to require
 ...
 */
@property (weak, nonatomic, readonly) NSArray *languageTags;

/**
 The raw NSDictionary language map.
 */
@property (weak, nonatomic, readonly) NSDictionary *map;
...
/**
 ...
 @return        The initialized language map.
 */
+ (EXPLanguageMap *) languageMapForCurrentLanguageWithString:(NSString *)aString;

/**
 Creates a language map from a dictionary.
 */
+ (EXPLanguageMap *) languageMapWithDictionary:(NSDictionary *)dict;
